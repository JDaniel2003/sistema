...
// app/Models/DatosTutores.php

protected static function booted()
{
    static::deleting(function ($datosTutor) {
        
        // 1. Eliminar Domicilio del Tutor
        if ($datosTutor->domicilioTutor) {
            // Asumiendo que el método de relación se llama domicilioTutor()
            $datosTutor->domicilioTutor->delete(); 
        }
    });
}
}
